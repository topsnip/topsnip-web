          ...
          <>
            ...
            <form onSubmit={handleEmailSignIn} className="flex flex-col gap-3">
              ...
              <button
                ...
                className="w-full rounded-xl py-3 text-sm font-semibold text-white transition-all disabled:opacity-40 hover:opacity-90 shadow-[0_0_20px_var(--ts-accent-30)]"
                style={{
                  background:
