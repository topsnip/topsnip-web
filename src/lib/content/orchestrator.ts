...
/** Max topics to process per run (budget guard — each topic = ~5 Claude calls + web enrichment)
 * Content generation has 120s limit. Enrichment + 4 Claude calls ~80s per topic. Keep at 1. */
